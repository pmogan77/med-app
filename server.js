...
const server = http.createServer((req, res) => {
      ...
      if (req.method === "POST") {
            ...
            intentMap.set('Disease Information', demo);
            intentMap.set('Disease Prediction', demo);
            intentMap.set('Disease Precautions', demo);
            ...
            if (pathName == "/generalInfo") {
            ...
            else if (pathName == "/symptomDescriptionData") {
                  var tableData = [];
            ...
            else if (pathName == "/symptomPrecautionData") {
                  var tableData = [];
            ...
            else if (pathName == "/symptomSeverityData") {
            ...
            else if (pathName == "/diseasePredictionData") {
                  var tableData = [];
                  ...
                  fs.readFile(
                        startPath + "/misc_controls_orbit.html",
                        "utf-8",
                        (err, data) => {
                              if (err) {
                                    console.log(err);
